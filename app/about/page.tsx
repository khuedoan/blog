    ...
    <>
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <article className="prose max-w-none">
          <p>
            Hey there, I&apos;m Khue! I&apos;m a Site Reliability Engineer. I
            have a wide range of interests in technology that I love to explore
            and tinker with.
          </p>
          <p>
          ...
          <p>
            ...
            I&apos;ve been working on, be sure to take a look{" "}
            <a href="https://github.com/khuedoan">here</a>. Who knows, you might
